  ...
  var PageableCollection = Backbone.PageableCollection = Backbone.Collection.extend({
    ...
    */
    fetch: function (options) {
      ...
      if (mode != "server") {
        var originalResetState = this._resetState;
        ...
        options.success = function (col, resp, opts) {
          ...
          if (self._resetState === originalResetState) {
            var models = col.models;
            if (mode == "client") fullCol.reset(models, opts);
            else {
              fullCol.add(models, _extend({at: fullCol.length, onRemove: true},
    ...
    reset: function() {
      this._resetState++;
      BBColProto.reset.apply(this, arguments);
    },
